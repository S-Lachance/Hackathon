# SHAP Analysis Report: Feature Contributions to Mortality (Original Model)
...
## Files Generated
- `shap_original_mortality_features.csv` - Full SHAP analysis for mortality
- `shap_original_survival_features.csv` - Full SHAP analysis for survival
- `shap_original_summary_plot.png` - SHAP summary visualization
- `shap_original_bar_plot.png` - Feature importance bar chart
- `shap_original_waterfall_high_risk.png` - Example high-risk prediction explanation
- `shap_original_waterfall_low_risk.png` - Example low-risk prediction explanation
